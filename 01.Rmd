...
new <-read.xlsx(xlsxFile="levene.xlsx", sheet=11, cols=c(5:14), rows=c(1:19), colNames=T)
...
library(openxlsx)
opts <- options(knitr.kable.NA = "",ggrepel.max.overlaps = Inf)
new <-read.xlsx(xlsxFile="levene.xlsx", sheet=11, cols=c(5:14), rows=c(30:41), colNames=T)
