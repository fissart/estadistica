...
\item
  Varianza \(s^2=\frac{f_i\sum\left(Y_i-\overline{x}\right )^2}{n-1}\)
\item
...
\item
  Coeficiente de variación \(CV=\frac{s}{\overline{x}}100\)
\end{itemize}

\hypertarget{medidas-de-posiciuxf3n-cuantiles}{%
\chapter{Medidas de posición (cuantiles)}\label{medidas-de-posiciuxf3n-cuantiles}}

Estos estadigrafos dividen al conjunto de datos en un número deternimado.
