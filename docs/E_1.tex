...
=======
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.22}}
...
>>>>>>> a2aadbf45175e339d9760f61633eed739404e11a
\bottomrule
\end{longtable}
...
=======
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.13}}
  >{\centering\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.07}}
  >{\centering\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.07}}
  >{\centering\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.07}}
  >{\centering\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.07}}
  >{\centering\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.13}}
  >{\centering\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.13}}
  >{\centering\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.14}}
  >{\centering\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.07}}
